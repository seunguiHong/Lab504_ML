...
# NN:
#   feature_groups = ["yoy_fwd"] or another constructed predictor block
#
# pcNN:
#   feature_groups = ["yoy_y"], ["yoy_fwd"], or another raw panel
...
# Sweep grid
# ============================================================
# Engine.py already treats Dropout and l1l2 as candidate grids inside one run.
# This outer sweep evaluates separate experiments for training parameters
# such as architecture, learning rate, patience, batch size, and the
# regularization candidate set itself.
...
base_run_tag = "sweep_NN_yoy_fwd_dy_oos1980"
